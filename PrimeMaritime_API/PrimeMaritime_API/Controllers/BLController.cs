...
namespace PrimeMaritime_API.Controllers
{
    ...
    public class BLController : ControllerBase
    {
        ...
        public ActionResult<Response<List<CONTAINERS>>> GetContainerList(string AGENT_CODE, string BOOKING_NO, string CRO_NO)
        {
            return Ok(JsonConvert.SerializeObject(_blService.GetContainerList(AGENT_CODE, BOOKING_NO, CRO_NO)));
        }
    }
}
